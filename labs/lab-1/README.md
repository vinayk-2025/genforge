...
- ✅ Node.js and Git configured  
- ✅ Ollama installed and running locally  
- ✅ Gemini CLI installed  
- ✅ Jupyter and LM Studio (optional)  
- ✅ XAMPP or MySQL service running (optional)
...
lab-1/
├── phase-1-checklists/
│   ├── python-installation-checklist.md
│   ├── nodejs-installation-checklist.md
│   ├── notepad-git-installation-checklist.md
│   ├── ollama-installation-checklist.md
│   ├── jupyter-installation-checklist.md
│   ├── lmstudio-installation-checklist.md
│   ├── xampp-installation-checklist.md
├── phase-2-online-labs/
│   ├── online-llm-lab.md
│   ├── online-llm-web-interfaces.md
│   ├── online-code-generator-lab.md
│   ├── online-image-generator-lab.md
│   ├── online-registrations.md
├── phase-3-validation/
│   ├── test_requirements.py
│   ├── test_node_hello_world.js
│   ├── test_git_config.sh
│   ├── test_ollama.py
...
├── setup-environment-phase-1.md
├── setup-environment-phase-2.md
├── setup-environment-phase-3.md
└── README.md
```
...
- Prepare for agentic workflows in Lecture 02  
...
🌐 [spnigam.in](https://spnigam.in) · 🧪 [aialchemyhub.in](https://www.aialchemyhub.in) · 📺 [YouTube](https://www.youtube.com/@AIAlchemyHub-zx6lz)  
💬 [community.aialchemyhub.in](https://community.aialchemyhub.in) · 💬 [aialchemyhub.zulipchat.com](https://aialchemyhub.zulipchat.com)  
📧 spnigam25@yahoo.com · 🔗 [LinkedIn](https://www.linkedin.com/in/spn25) · 💻 [GitHub](https://github.com/satya25) · 🤖 [Hugging Face](https://huggingface.co/satya25)
